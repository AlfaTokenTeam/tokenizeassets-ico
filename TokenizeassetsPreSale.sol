...
import "./Tokenizeassets.sol";

contract TokenizeassetsPreSale {
    Tokenizeassets public token;
    ...
    function TokenizeassetsPreSale(
        Tokenizeassets _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = Tokenizeassets(_token);
